...
export function Floating({ count = 5 }) {
  ...
  const availableIcons = [
    <Copy size={24} color="#d74dceff" key="copy" />,
    <Cloud size={24} color="#d74dceff" key="cloud" />,
    <Book size={24} color="#d74dceff" key="book" />,
    <Cpu size={24} color="#d74dceff" key="cpu" />,
    <Github size={24} color="#d74dceff" key="github" />,
    <Link size={24} color="#d74dceff" key="link" />,
    <Link2 size={24} color="#d74dceff" key="link2" />,
    <ReactJS size={24} color="#d74dceff" key="react"/>,
  ]
  useEffect(() => {
