  ...
  return (
    <div className="w-full font-sans md:px-10 relative z-10" ref={containerRef}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        <h2 className="text-5xl md:text-5xl mb-4 text-white dark:text-white max-w-4xl drop-shadow-[0_0_10px_rgba(236,72,153,0.8)] ">
         Work Experience and Acheivements
        </h2>
      </div>
              ...
              <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                <div
                  ...
                  className={`h-10 absolute left-3 md:left-3 w-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                    isActive
                      ? "ring-4 ring-blue-400 drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]"
                      : ""
                  }`}
                >
                  <div
              ...
              <div className="relative pl-20 pr-4 md:pl-4 w-full">
                <h3
                  className={`md:hidden block text-2xl mb-4 text-left font-bold transition-all duration-300 ${
                    isActive
                      ? "text-blue-200 drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]"
                      : "text-neutral-500 dark:text-neutral-500"
                  }`}
                >
                  {item.title}
...
<motion.div
  ...
  className="absolute left-8 top-0 w-[2px] bg-gradient-to-b from-transparent via-blue-400 via-50% to-purple-500 to-90% drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]"
>
